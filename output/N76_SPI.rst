      ...
      00048B 22               [24]  404 	ret
                                    ...
                                    413 ;	-----------------------------------------
      00048C                        414 _SPI_transfer:
      00048C 85 82 F5         [24]  415 	mov	_spdr,dpl
                                    416 ;	./src/N76_SPI.c:32: __asm__("nop");
      00048F 00               [12]  417 	nop
                                    418 ;	./src/N76_SPI.c:33: while (inbit(SPSR, SPIF) == 0)
      000490                        419 00101$:
      000490 74 80            [12]  420 	mov	a,#0x80
      000492 55 F4            [12]  421 	anl	a,_spsr
      000494 23               [12]  422 	rl	a
      000495 54 01            [12]  423 	anl	a,#0x01
      000497 60 F7            [24]  424 	jz	00101$
                                    425 ;	./src/N76_SPI.c:35: clrb(SPSR, SPIF);
      000499 53 F4 7F         [24]  426 	anl	_spsr,#0x7f
                                    427 ;	./src/N76_SPI.c:36: }
      00049C 22               [24]  428 	ret
                                    429 	.area CSEG    (CODE)
                                    430 	.area CONST   (CODE)
                                    431 	.area XINIT   (CODE)
