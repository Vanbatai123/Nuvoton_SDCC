      ...
      0005CB                        372 __delay_ms:
                           ...
                           000001   379 	ar1 = 0x01
                           000000   380 	ar0 = 0x00
      0005CB AC 82            [24]  381 	mov	r4,dpl
      0005CD AD 83            [24]  382 	mov	r5,dph
      0005CF AE F0            [24]  383 	mov	r6,b
      0005D1 FF               [12]  384 	mov	r7,a
                                    385 ;	./src/include.c:12: T3CON |= 0x07;                           		//Timer3 Clock = Fsys/128
      0005D2 AA C4            [24]  386 	mov	r2,_t3con
      0005D4 7B 00            [12]  387 	mov	r3,#0x00
      0005D6 43 02 07         [24]  388 	orl	ar2,#0x07
      0005D9 8A C4            [24]  389 	mov	_t3con,r2
                                    390 ;	./src/include.c:13: setb(T3CON, TR3);                                		//Trigger Timer3 start run
      0005DB 43 C4 08         [24]  391 	orl	_t3con,#0x08
                                    392 ;	./src/include.c:14: while (__ms != 0)
      0005DE                        393 00104$:
      0005DE EC               [12]  394 	mov	a,r4
      0005DF 4D               [12]  395 	orl	a,r5
      0005E0 4E               [12]  396 	orl	a,r6
      0005E1 4F               [12]  397 	orl	a,r7
      0005E2 60 23            [24]  398 	jz	00106$
                                    399 ;	./src/include.c:16: RL3 = 0x83; //Find  define in "Function_define.h" "TIMER VALUE"
      0005E4 75 C5 83         [24]  400 	mov	_rl3,#0x83
                                    401 ;	./src/include.c:17: RH3 = 0xFF;
      0005E7 75 C6 FF         [24]  402 	mov	_rh3,#0xff
                                    403 ;	./src/include.c:18: while (inbit(T3CON,TF3) != 1);		//Check Timer3 Time-Out Flag
      0005EA                        404 00101$:
      0005EA 74 10            [12]  405 	mov	a,#0x10
      0005EC 55 C4            [12]  406 	anl	a,_t3con
      0005EE C4               [12]  407 	swap	a
      0005EF 54 0F            [12]  408 	anl	a,#0x0f
      0005F1 FB               [12]  409 	mov	r3,a
      0005F2 BB 01 F5         [24]  410 	cjne	r3,#0x01,00101$
                                    411 ;	./src/include.c:19: clrb(T3CON, TF3);
      0005F5 53 C4 EF         [24]  412 	anl	_t3con,#0xef
                                    413 ;	./src/include.c:22: __ms--;
      0005F8 1C               [12]  414 	dec	r4
      0005F9 BC FF 09         [24]  415 	cjne	r4,#0xff,00129$
      0005FC 1D               [12]  416 	dec	r5
      0005FD BD FF 05         [24]  417 	cjne	r5,#0xff,00129$
      000600 1E               [12]  418 	dec	r6
      000601 BE FF 01         [24]  419 	cjne	r6,#0xff,00129$
      000604 1F               [12]  420 	dec	r7
      000605                        421 00129$:
      000605 80 D7            [24]  422 	sjmp	00104$
      000607                        423 00106$:
                                    424 ;	./src/include.c:24: clrb(T3CON, TR3);                                		//Stop Timer3
      000607 53 C4 F7         [24]  425 	anl	_t3con,#0xf7
                                    426 ;	./src/include.c:25: }
      00060A 22               [24]  427 	ret
                                    428 ;------------------------------------------------------------
                                    429 ;Allocation info for local variables in function '_delay_us'
                                    430 ;------------------------------------------------------------
                                    431 ;_us                       Allocated to registers 
                                    432 ;------------------------------------------------------------
                                    433 ;	./src/include.c:27: void _delay_us(uint32_t _us)
                                    434 ;	-----------------------------------------
                                    435 ;	 function _delay_us
                                    436 ;	-----------------------------------------
      00060B                        437 __delay_us:
      00060B 85 82 75         [24]  438 	mov	__mullong_PARM_2,dpl
      00060E 85 83 76         [24]  439 	mov	(__mullong_PARM_2 + 1),dph
      000611 85 F0 77         [24]  440 	mov	(__mullong_PARM_2 + 2),b
      000614 F5 78            [12]  441 	mov	(__mullong_PARM_2 + 3),a
                                    442 ;	./src/include.c:29: _us = _us * 5 / 4+1;
      000616 90 00 05         [24]  443 	mov	dptr,#(0x05&0x00ff)
      000619 E4               [12]  444 	clr	a
      00061A F5 F0            [12]  445 	mov	b,a
      00061C 12 06 7C         [24]  446 	lcall	__mullong
      00061F AC 82            [24]  447 	mov	r4,dpl
      000621 AD 83            [24]  448 	mov	r5,dph
      000623 AE F0            [24]  449 	mov	r6,b
      000625 C3               [12]  450 	clr	c
      000626 13               [12]  451 	rrc	a
      000627 FF               [12]  452 	mov	r7,a
      000628 EE               [12]  453 	mov	a,r6
      000629 13               [12]  454 	rrc	a
      00062A FE               [12]  455 	mov	r6,a
      00062B ED               [12]  456 	mov	a,r5
      00062C 13               [12]  457 	rrc	a
      00062D FD               [12]  458 	mov	r5,a
      00062E EC               [12]  459 	mov	a,r4
      00062F 13               [12]  460 	rrc	a
      000630 FC               [12]  461 	mov	r4,a
      000631 EF               [12]  462 	mov	a,r7
      000632 C3               [12]  463 	clr	c
      000633 13               [12]  464 	rrc	a
      000634 FF               [12]  465 	mov	r7,a
      000635 EE               [12]  466 	mov	a,r6
      000636 13               [12]  467 	rrc	a
      000637 FE               [12]  468 	mov	r6,a
      000638 ED               [12]  469 	mov	a,r5
      000639 13               [12]  470 	rrc	a
      00063A FD               [12]  471 	mov	r5,a
      00063B EC               [12]  472 	mov	a,r4
      00063C 13               [12]  473 	rrc	a
      00063D FC               [12]  474 	mov	r4,a
      00063E 0C               [12]  475 	inc	r4
      00063F BC 00 09         [24]  476 	cjne	r4,#0x00,00112$
      000642 0D               [12]  477 	inc	r5
      000643 BD 00 05         [24]  478 	cjne	r5,#0x00,00112$
      000646 0E               [12]  479 	inc	r6
      000647 BE 00 01         [24]  480 	cjne	r6,#0x00,00112$
      00064A 0F               [12]  481 	inc	r7
      00064B                        482 00112$:
                                    483 ;	./src/include.c:30: while (--_us)
      00064B                        484 00101$:
      00064B 1C               [12]  485 	dec	r4
      00064C BC FF 09         [24]  486 	cjne	r4,#0xff,00113$
      00064F 1D               [12]  487 	dec	r5
      000650 BD FF 05         [24]  488 	cjne	r5,#0xff,00113$
      000653 1E               [12]  489 	dec	r6
      000654 BE FF 01         [24]  490 	cjne	r6,#0xff,00113$
      000657 1F               [12]  491 	dec	r7
      000658                        492 00113$:
      000658 EC               [12]  493 	mov	a,r4
      000659 4D               [12]  494 	orl	a,r5
      00065A 4E               [12]  495 	orl	a,r6
      00065B 4F               [12]  496 	orl	a,r7
      00065C 70 ED            [24]  497 	jnz	00101$
                                    498 ;	./src/include.c:35: }
      00065E 22               [24]  499 	ret
                                    500 	.area CSEG    (CODE)
                                    501 	.area CONST   (CODE)
                                    502 	.area XINIT   (CODE)
